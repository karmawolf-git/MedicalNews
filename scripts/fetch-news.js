...
const SOURCES = [
  ...
  { id: "gn_caduet_kr", name: "카듀엣·복합제 (국내)", country: "KR", prod: "caduet",
    rss: `https://news.google.com/rss/search?q=${encodeURIComponent("카듀엣 OR 암로디핀 아토르바스타틴 OR 고혈압 이상지질혈증 복합제 OR 심혈관 복합 치료 OR 고정용량복합제 after:" + dateAfter(14))}&hl=ko&gl=KR&ceid=KR:ko` },
  { id: "gn_caduet_en", name: "Caduet·Combo (Global)", country: "US", prod: "caduet",
    rss: `https://news.google.com/rss/search?q=${encodeURIComponent("caduet OR amlodipine atorvastatin OR fixed dose combination hypertension dyslipidemia OR cardiovascular combination therapy after:" + dateAfter(14))}&hl=en-US&gl=US&ceid=US:en` },
